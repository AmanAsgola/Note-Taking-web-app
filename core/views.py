...
@core.route("/tags/add/", methods=['GET', 'POST'])
@login_required
def add_tag():
    '''
...
@core.route("/profile/settings/change_email/", methods=['GET', 'POST'])
@login_required
def change_email():
    '''
...
@core.route("/profile/settings/change_password/", methods=['GET', 'POST'])
@login_required
def change_password():
    '''
